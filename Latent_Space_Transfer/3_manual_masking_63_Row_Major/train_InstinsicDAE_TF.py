...
if ON_SERVER:
    out_path = '/nfs/bigdisk/bsonawane/LightTransfer_Exp/Latent_Space/1_63_Row_Major/' #cropped_multipie/4_manual_masking_map_approach_for_lighting_only_multipie_cropped_63/'
