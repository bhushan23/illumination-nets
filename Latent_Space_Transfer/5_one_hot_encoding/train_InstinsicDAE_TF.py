...
if ON_SERVER:
    out_path = '/nfs/bigdisk/bsonawane/LightTransfer_Exp/Latent_Space/3_One_Hot_Vector/' #cropped_multipie/4_manual_masking_map_approach_for_lighting_only_multipie_cropped_63/'
...
print("Dataset Loaded- Train data:", len(dataloader), " Test Data: ", len(dataloader_test))
