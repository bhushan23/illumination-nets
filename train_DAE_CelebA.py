...
parser.add_argument('--dirCheckpoints', default='/nfs/bigdisk/bsonawane/daeout/checkpoints/DAE_CelebA', help='folder to model checkpoints')
parser.add_argument('--dirImageoutput', default='/nfs/bigdisk/bsonawane/daeout/images/DAE_CelebA', help='folder to output images')
parser.add_argument('--dirTestingoutput', default='/nfs/bigdisk/bsonawane/daeout/testing/DAE_CelebA', help='folder to testing results/images')
